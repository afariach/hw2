...
2. Create a release. Follow [these instructions](https://github.com/Optimal-Control-16-745/hw2/blob/main/src/hw2.jl#L6) for more info on creating the release.
